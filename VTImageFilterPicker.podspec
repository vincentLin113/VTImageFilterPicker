...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/vincentLin113/VTImageFilterPicker.git', :tag => '1.0.0.2' }
  s.source_files = 'Source/*.swift, Source/CustomUI/*.swift, Source/Extension/*.swift'
